...
*Документ подготовлен 2026-06-28. Источники: прямое чтение кода (`src/`), live-проверка тестов (89 passed) и Neo4j-подключения, чтение `.planning/` и вики-документации, git log. Видимая ссылка из [HOME](../HOME.md).*
